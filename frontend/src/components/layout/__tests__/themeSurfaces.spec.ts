...
describe('全局主题表面', () => {
  ...
  it('为明暗工作区使用液态玻璃层级', () => {
    ...
    expect(cardBlock).toContain('dark:border-dark-600/80')
    expect(lightSurfaceBlock).toContain('background-color: rgba(250, 253, 255, 0.64);')
    expect(lightSurfaceBlock).toContain('backdrop-filter: blur(20px) saturate(150%);')
    expect(lightSurfaceBlock).toContain('inset 0 1px 0 rgba(255, 255, 255, 0.95)')
    expect(darkSurfaceBlock).toContain('background-color: rgba(29, 35, 41, 0.6);')
    expect(darkSurfaceBlock).toContain('backdrop-filter: blur(20px) saturate(128%);')
    expect(darkSurfaceBlock).toContain('inset 0 1px 0 rgba(255, 255, 255, 0.08)')
    expect(dataTableSource).toContain('--sticky-col-bg: rgba(250, 253, 255, 0.6);')
    expect(dataTableSource).toContain('--sticky-col-bg: rgba(29, 35, 41, 0.6);')
    ...
    expect(styleSource).toContain('background-color: rgba(255, 255, 255, 0.68) !important;')
    expect(styleSource).toContain('border-color: rgba(94, 128, 143, 0.3) !important;')
  })
})
