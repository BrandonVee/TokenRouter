<template>
  ...
  <div class="dashboard-metrics grid grid-cols-2 gap-4 lg:grid-cols-4">
    ...
    <div v-if="!isSimple" class="dashboard-metric dashboard-metric-success">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xl font-bold text-emerald-600 dark:text-emerald-400">{{ formatBalanceAmount(balance, { fractionDigits: 2 }) }}</p>
    ...
    <!-- Today Cost -->
    <div class="dashboard-metric dashboard-metric-violet" data-testid="user-dashboard-cost">
      <div class="flex items-center gap-3">
