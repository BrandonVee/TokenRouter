...
// API Keys
  keys: {
    ...
    smartRouting: {
      label: 'Smart group routing',
      hint: 'Selection order sets group priority; smart routing ranks channels within each group.',
      modeLabel: 'Routing mode',
      overrideHint: 'Request-level routing overrides are supported.',
      candidateGroups: 'Eligible model groups',
      candidateGroupsHint: 'Requests use the first available selected group; order also controls fallback priority.',
      channelHint: 'Choose a channel within the selected model groups using live routing signals.',
      enabled: 'Enabled',
      disabled: 'Disabled',
      manualHint: 'Use group priority and each group default scheduler',
      quickTitle: 'Groups and routing',
      quickHint: 'Choose eligible model groups and the channel ordering strategy.',
      quickOrderHint: 'Numbers indicate group priority',
      shortSmart: 'Smart',
      requestOverrideHint: 'A model suffix or provider.sort in the API request overrides this key strategy.',
      ...
      priceHint: 'Prefer channels with lower cost',
      successMode: 'Success rate first',
      successHint: 'Prefer channels with recent stability',
      addGroup: 'Add candidate group',
    ...
    rateLimit7d: 'Weekly Limit (7 days)',
    rateLimit30d: 'Monthly Limit (30 days)',
    rateLimitHint: 'Set the maximum spending for this key within each time window. 0 = unlimited.',
    rateLimitUsage: 'Spending Usage',
    resetRateLimitUsage: 'Reset Spending Usage',
    resetRateLimitTitle: 'Confirm Reset Spending Usage',
    resetRateLimitConfirmMessage: 'Are you sure you want to reset the spending usage for key "{name}"? All time window usage will be reset to zero. This action cannot be undone.',
    rateLimitResetSuccess: 'Spending usage reset successfully',
    failedToResetRateLimit: 'Failed to reset spending usage',
