...
marketplace: {
    ...
    groupDetail: 'Full Group Details',
    viewPricing: 'View detailed pricing',
    viewGroupPricing: 'View this group pricing',
    imagePricing: 'Image Pricing',
    perImage: '/ image',
    searchPlaceholder: 'Search brands, groups, model IDs, or display names',
    displayMode: 'Display Mode',
    displayByModel: 'Model - Group',
    displayByGroup: 'Group - Model',
    allBrands: 'All Brands',
    allPlatforms: 'All Brands',
    allTypes: 'All Types',
    ...
    passiveAvailabilityAriaLabel: 'Latest 60 time buckets of {minutes} minutes each: green means success or no data, yellow means degraded service or upstream failures.',
    degradedTitle: 'Service temporarily degraded',
    ...
    fastImageInput: 'Fast Image Input',
    fastOutput: 'Fast Output',
    fastCacheWrite: 'Fast Cache Write',
    fastCacheRead: 'Fast Cache Read',
    fastImageOutput: 'Fast Image Output',
    unpriced: 'Unpriced',
    pricingUnavailable: 'No display pricing is currently available for this model.',
    emptyTitle: 'No matching models',
    emptyDescription: 'Try a different keyword or switch the brand filter.',
    platforms: {
      openai: 'OpenAI API',
...
// Onboarding Tour
  onboarding: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to TokenRouter',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the TokenRouter AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
    ...
    team: {
      ...
      members: {
        ...
        description: '<div class="tour-step-description"><p>Owners can review every member here and set individual daily, weekly, and monthly limits.</p><p class="tour-info-box">Removing a member immediately disables their team keys without affecting personal keys.</p></div>'
      },
      invitations: {
        title: 'Invite members',
        description: '<div class="tour-step-description"><p>Enter an email address to send a targeted invitation valid for seven days. You can also review its status, resend it, or revoke a pending invitation.</p></div>'
      },
      settings: {
        title: 'Team settings',
      ...
      keyScope: {
        ...
        description: '<div class="tour-step-description"><p>This menu switches between personal and team keys. The team scope is now active, so new keys use the owner\'s balance, subscription, and group entitlements.</p></div>'
      },
      createKey: {
      ...
      usagePage: {
        title: 'Open usage records',
        description: '<div class="tour-step-description"><p>Personal and team requests are combined in usage records. The next step opens the team usage area.</p></div>',
        noTeamDescription: '<div class="tour-step-description"><p>After the team starts generating usage, usage records add member spending trends and comparisons, and the details table identifies the member behind each request.</p></div>'
      },
      ownerUsage: {
        title: 'Member usage',
        description: '<div class="tour-step-description"><p>Owners can compare member spending and trends over time. The details table below also identifies the member who made each request.</p></div>'
      },
      memberUsage: {
        title: 'Review team requests',
        description: '<div class="tour-step-description"><p>Members can only review their own team and personal requests. Other members\' usage and the owner\'s balance and subscription details remain private.</p></div>'
      },
      done: 'Finish guide'
    }
  },
// Payment System
  payment: {
    ...
    rechargeRatePreview: 'Current rate: 1 CNY = {amount} {unitName}',
    ...
    errors: {
      ...
      billingRequired: 'Enter billing name and billing email.',
      ...
      REFUND_FAILED: 'Refund failed.',
      BILLING_INFO_REQUIRED: 'Billing information is required.',
      BILLING_NAME_REQUIRED: 'Billing name is required.',
      BILLING_EMAIL_REQUIRED: 'Billing email is required.',
      BILLING_EMAIL_INVALID: 'Billing email is invalid.',
      BILLING_TAX_ID_INVALID: 'Tax ID type and value must be provided together.',
      PAYMENT_DOCUMENT_UNSUPPORTED: 'This order does not support invoice or receipt.',
      PAYMENT_DOCUMENT_NOT_FOUND: 'Invoice or receipt is not available yet.',
    },
    ...
    admin: {
      ...
      purchaseDistribution: 'Plan / Pay-As-You-Go Purchases',
      purchaseItem: 'Purchase Item',
      amountShare: 'Amount Share',
      countShare: 'Order Count Share',
      ...
      insufficientBalance: 'Insufficient balance — user balance will be reduced to 0',
