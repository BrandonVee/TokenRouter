...
// Accounts
    accounts: {
      ...
      usageWindowsHint: '"5h / 7d" are the upstream account\'s official rolling usage windows (e.g. OpenAI ChatGPT, Claude). They are imposed by the upstream provider on the account itself — not configured by TokenRouter, and unrelated to the models you map. Usage resets automatically once each window rolls over, and the limit cannot be lifted from within TokenRouter.',
      ollamaCloud: {
      ...
      geminiImageTestHint:
        'Uses the native Gemini generateContent format and shows the returned image below.',
      ...
      imageResponse: 'API response details',
      apiResponseDetails: 'API response details',
      copyApiResponse: 'Copy API response',
      imageResponseCopied: 'API response copied',
      completeResponse: 'Complete response',
      sseEvents: 'SSE events',
      rawSseEvents: 'Raw upstream SSE events',
      copyCompleteResponse: 'Copy complete response',
      completeResponseCopied: 'Complete response copied',
      copyRawSse: 'Copy all raw SSE',
      rawSseCopied: 'Raw SSE copied',
      copySseEvent: 'Copy this SSE event',
      sseEventCopied: 'SSE event copied',
