...
// Channel Management
    channels: {
      ...
      form: {
        ...
        peakRateTitle: 'Peak pricing',
        peakRateStatusOn: 'Enabled',
        peakRateStatusOff: 'Disabled',
        peakRateDescription: 'Apply a model Token price multiplier during selected server-time windows',
        peakRateWindowsTitle: 'Pricing windows',
        peakRateWindowsSummary: '{count} windows',
        peakRateWindowLabel: 'Peak window {index}',
        peakRateEnabled: 'Enable peak pricing for this model',
        peakStart: 'Peak starts',
        peakEnd: 'Peak ends',
        peakRateMultiplier: 'Peak price multiplier',
        peakRateWeekdays: 'Applies on',
        addPeakRateWindow: 'Add pricing window',
        removePeakRateWindow: 'Remove pricing window',
        peakRateHint: 'Uses the server timezone; supports multiple windows and overnight periods.',
        peakRateInvalid: 'Model {models} has an invalid peak pricing configuration.',
        peakRateWindowsRequired: 'Add at least one pricing window',
        peakRateWindowsLimit: 'At most 32 pricing windows are allowed',
        peakRateWeekdaysInvalid: 'Select at least one unique weekday for each pricing window',
        peakRateOverlap: 'Pricing windows cannot overlap',
        weekdayMon: 'Mon',
        weekdayTue: 'Tue',
        weekdayWed: 'Wed',
        weekdayThu: 'Thu',
