...
// Settings
	...
	invoice: {
      ...
      preAggregation: {
        ...
        unavailable: 'Disabled by deployment configuration',
        noData: 'No data',
        save: 'Save pre-aggregation settings',
        saved: 'Pre-aggregation settings saved',
        loadFailed: 'Failed to load pre-aggregation settings',
        saveFailed: 'Failed to save pre-aggregation settings',
        backfill: 'Manual backfill',
        backfillDays: 'Recent days',
        startBackfill: 'Start backfill',
        backfillAccepted: 'Backfill job accepted',
        backfillFailed: 'Failed to start backfill',
        phases: {
          idle: 'Idle',
          live: 'Live aggregation',
      ...
      marketplaceAvailability: {
        ...
        mode: 'Data source',
        modeHint:
          'Active mode sends scheduled lightweight requests; passive mode shows the latest 60 time buckets.',
        activeMode: 'Active probes (current behavior)',
        passiveMode: 'Passive probes (60 time buckets)',
      ...
      features: {
        ...
        affiliate: {
          ...
          description: 'Existing users earn rebate points based on the number of reasoning points their invitees actually purchase.',
          ...
          rebateRateHint: 'Calculated from reasoning points actually purchased, 0-100. For example, 1,000 points at 20% yields 200 rebate points.',
          ...
          perInviteeCap: 'Per-Invitee Rebate Cap ({unitName})',
          perInviteeCapDesc: 'Maximum rebate points generated by one invitee, using the same unit as balance. 0 = no limit.'
        },
      },
      registration: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for TokenRouter end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for TokenRouter end-user login',
      ...
      defaults: {
        ...
        defaultUserApiKeyLimit: 'Default API Key Limit',
        defaultUserApiKeyLimitHint: 'Default number of API keys new users can create; 0 = unlimited. Only applied at new user creation.',
        defaultUserApiKeyLimitInvalid: 'Default API Key limit must be an integer from 0 to 2,147,483,647',
      ...
      balanceDisplay: {
        ...
        description: 'Configure the internal balance unit name, symbol, and icon without changing external payment currencies.',
        unitName: 'Unit Name',
        unitNamePlaceholder: 'USD',
        unitNameHint: 'Displayed as the balance unit name, for example USD, Credits, or Points.',
        unitSymbol: 'Unit Symbol',
        unitSymbolPlaceholder: '$',
        unitSymbolHint: 'Displayed as the amount prefix, for example $, ¥, or C.',
        reasoningPointRmbUnitPrice: 'Reasoning Point CNY Unit Price',
        reasoningPointRmbUnitPricePlaceholder: 'e.g. 1',
        reasoningPointRmbUnitPriceHint: 'Used for marketplace discount display. The CNY value of 1 reasoning point.',
        usdExchangeRate: 'USD Exchange Rate',
        usdExchangeRatePlaceholder: 'e.g. 7.2',
        usdExchangeRateHint: 'Used for marketplace discount display. CNY per 1 USD.',
        iconSvg: 'Balance Icon SVG',
        iconHint: 'Upload a custom SVG icon. Leave empty to use the default icon.',
        uploadSvg: 'Upload SVG',
        removeSvg: 'Remove SVG',
        previewLabel: 'Preview',
        previewUnit: 'Balance Unit: {unitName}',
      ...
      scheduling: {
        ...
        accountSchedulingThresholdsDisabledHint: '100 disables platform auto-pause. Values 1-99 pause scheduling once utilization reaches that percentage.',
        accountSchedulingThresholdsRangeHint: 'Integer 1-100 (percent). OpenAI, Anthropic, and Grok only.',
        advancedTitle: 'General Advanced Scheduler',
        advancedDescription: 'Advanced scheduling is enabled per group. It uses shared candidate scoring, Top-K weighted selection, and runtime error-rate and time-to-first-token feedback. Basic groups keep the existing scheduler.',
        stickyWeightedTitle: 'Sticky weighting',
        stickyWeightedDescription: 'When enabled, previous-response and session affinity participate as score signals; when disabled, existing sticky-first behavior is preserved.',
        subscriptionPriorityTitle: 'Subscription priority',
        subscriptionPriorityDescription: 'Accounts with subscription capabilities receive a subscription-priority score; accounts without that signal remain neutral.',
        weightsTitle: 'Advanced scheduler weights',
        weightsDescription: 'Blank values use config or built-in defaults. Non-blank settings take precedence and apply to every advanced group.',
        ...
        previousResponseWeight: 'Previous response sticky',
        sessionStickyWeight: 'Session sticky',
        advancedHelp: {
          trigger: 'View advanced scheduler scoring and selection',
          title: 'How advanced scheduling works',
          summary: 'Requests pass hard filters first, then the remaining account candidates are scored; the highest scoring candidates enter the Top-K pool.',
          formula: 'Score = normalized signals × weights + optional affinity bonuses',
          hardFilterTitle: 'Hard filters:',
          hardFilter: 'Exclude accounts that fail the group, model and capability, account-status, rate-limit, proxy, or concurrency-slot constraints.',
          scoreTitle: 'Score candidates:',
          score: 'Priority, lower load, shorter queue, lower error rate, lower time to first token, reset window, and quota headroom are weighted together; unavailable optional signals stay neutral.',
          feedbackTitle: 'Use runtime feedback:',
          feedback: 'Request outcomes and time to first token update smoothed account performance, allowing later requests to avoid accounts that recently perform poorly.',
          selectionTitle: 'Select from Top-K:',
          selection: 'Keep the highest scoring Top-K candidates, then select by score weight to avoid long-term concentration on one account. Sticky weighting gives the previous-response and session accounts extra preference.',
          boundary: 'Every attempt rechecks hard constraints. A group fallback schedules again for its target group, and an account is never switched after a response stream has started.'
        }
      },
      openaiScheduling: {
        title: 'OpenAI Scheduling Settings',
        description: 'Control automatic quota pausing for OpenAI accounts'
      },
      ollamaCloudUsage: {
      ...
      gatewayForwarding: {
        ...
        grokTitle: 'Grok Request Forwarding',
        grokDescription: 'Control the default Grok model, cross-client mapping, and upstream region',
        ...
        grokDefaultTextModelHint: 'Used by Grok requests that need a default text model and as the target for the Claude Messages mapping below. Custom Grok text model IDs are accepted.',
        grokCrossClientMap: 'Map Claude Messages models to Grok',
        grokCrossClientMapHint: 'When enabled, Claude model IDs received by Grok groups through the Anthropic Messages API are routed to the default Grok text model. Other models in Responses or Chat Completions are unaffected.',
        grokDefaultBaseURLMode: 'Default Grok upstream',
        grokDefaultBaseURLModeHint: 'Used when a Grok account has no explicit base URL. Media and voice endpoints continue to use their official API hosts.',
        ...
        openaiCodexUserAgentHint: 'Used to bypass Cloudflare browser-UA challenges on the OpenAI upstream. Only applies when the client User-Agent is detected as a browser (Mozilla/...). Leave empty to use the built-in codex-tui default.',
      ...
      userPromptReplacement: {
        ...
        patternPlaceholder: '(?s)(<environment_context\\b[^>]*>.*?<timezone>)([^<]*)(</timezone>.*?</environment_context>)',
        targetGroup: 'Target Group',
        replacementType: 'Replacement Type',
        typeStatic: 'Static Text',
        typeTimezoneName: 'Timezone Name',
        typeCurrentTime: 'Current Time',
        staticText: 'Static Text',
        staticTextPlaceholder: 'Replacement text',
        timezone: 'Target Timezone',
        useTimezone: 'Use timezone',
      ...
      site: {
        ...
        siteName: 'Site Name',
        siteNamePlaceholder: 'TokenRouter',
        ...
        siteNameZhPlaceholder: 'TokenRouter',
        siteNameEn: 'Site Name (English)',
        siteNameEnPlaceholder: 'TokenRouter',
        ...
        tablePreferencesTitle: 'Tables and Ranking',
        tablePreferencesDescription: 'Configure shared table pagination and user ranking display rules',
        ...
        usageRankingSortBy: 'Ranking order',
        usageRankingSortByHint: 'Rank users by total tokens or actual spend.',
        usageRankingSortTokens: 'Sort by tokens',
        usageRankingSortAmount: 'Sort by amount',
        usageRankingShowTokens: 'Show token count',
        usageRankingShowTokensHint: 'Controls token data in ranking cards and rows.',
        usageRankingShowRequests: 'Show request count',
        usageRankingShowRequestsHint: 'Controls request counts in ranking cards and rows.',
        usageRankingShowAmount: 'Show spend amount',
        usageRankingShowAmountHint: 'When disabled, spend amounts are omitted from both the API and page.',
        customEndpoints: {
      ...
      customMenu: {
        ...
        description: 'Add custom pages to the sidebar navigation and set Chinese and English names separately. The sidebar follows the current language and falls back to the other name or the legacy label when empty. Each page can be visible to regular users or administrators.',
        itemLabel: 'Menu Item #{n}',
        name: 'Menu Name',
        namePlaceholder: 'e.g. Help Center',
        nameZh: 'Chinese Name',
        nameZhPlaceholder: 'e.g. 帮助中心',
        nameEn: 'English Name',
        nameEnPlaceholder: 'e.g. Help Center',
        url: 'Page URL',
      ...
      payment: {
        ...
        rechargeFeeRate: 'Global Default Fee Rate',
        rechargeFeeRateHint: 'Default percentage used when a payment method has no separate fee setting, 0 means no fee',
        rechargeFeePreview: 'Preview: Recharge 100, fee {fee}',
        methodFeesTitle: 'Payment Method Fees',
        methodFeesHint: 'When separate settings are enabled, the method uses fixed fee plus fee rate. Otherwise it uses the global default rate.',
        paymentMethod: 'Payment Method',
        fixedFee: 'Fixed Fee',
        feeRate: 'Fee Rate',
        methodFeeResult: 'Fee Preview',
        methodFeeFallback: 'Uses global default fee rate',
        methodFeePreview: 'Preview: fee {fee} on 100, pay {amount}',
        ...
        helpTextHint: 'Markdown is supported, including links, bold text, and lists.',
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on TokenRouter orders; the upstream type is sent as EasyPay type.',
      ...
      smtp: {
        ...
        fromName: 'From Name',
        fromNamePlaceholder: 'TokenRouter',
        useTls: 'Use TLS',
...
// TLS Fingerprint Profiles
    tlsFingerprintProfiles: {
      ...
      collector: {
        title: 'Built-in Fingerprint Collector',
        description: 'Start a temporary HTTPS collector from this page to capture real Claude Code and Codex CLI ClientHello data.',
        running: 'Running',
        stopped: 'Stopped',
        start: 'Start',
        stop: 'Stop',
        ...
        generatedCert: 'Temporary self-signed CA',
        configuredCert: 'Configured certificate',
        createSession: 'Create Session',
        refreshCaptures: 'Refresh Captures',
        captureURL: 'Capture URL',
        expiresAt: 'Expires At',
        claudeCommand: 'Claude Code',
        codexCommand: 'Codex CLI Command',
        codexConfig: 'Codex CLI Config',
        copyCA: 'Copy CA',
        downloadCA: 'Download CA',
        captures: 'Captures',
        captureCount: '{count} records',
        noCaptures: 'No captures yet. Run a client with the command above and results will appear here.',
        copyYaml: 'Copy YAML',
        applyCapture: 'Fill Form',
        unknownClient: 'Unknown Client',
        statusFailed: 'Failed to load collector status',
        startSuccess: 'Collector started',
        stopSuccess: 'Collector stopped',
        actionFailed: 'Collector action failed',
        sessionCreated: 'Capture session created',
        sessionFailed: 'Failed to create capture session',
        applied: 'Capture filled into the form',
