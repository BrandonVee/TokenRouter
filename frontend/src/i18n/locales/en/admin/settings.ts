...
// Settings
    settings: {
      ...
      marketplaceAvailability: {
        ...
        mode: 'Data source',
        modeHint:
          'Active mode sends scheduled lightweight requests; passive mode uses the latest 300 eligible requests.',
        activeMode: 'Active probes (current behavior)',
        passiveMode: 'Passive probes (latest 300 eligible requests)',
      ...
      customMenu: {
        ...
        description: 'Add custom pages to the sidebar navigation and choose iframe, current tab, or new tab opening. Each page can be visible to regular users or administrators.',
