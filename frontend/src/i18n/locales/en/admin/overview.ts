...
backup: {
      ...
      s3: {
        ...
        uploadMode: 'Backup Upload Mode',
        uploadModeMultipart: 'Low-memory Multipart',
        uploadModeSpooled: 'Compatibility Spool',
        uploadModeHint: 'Use low-memory multipart for Cloudflare R2 and AWS S3. Use compatibility spool for S3 services that do not support multipart signatures.',
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: 'Click "Create bucket", enter a name (e.g. tokenrouter-backups), choose a region',
