...
marketplace: {
    ...
    groupDetail: '完整分组信息',
    viewPricing: '查看详细定价',
    viewGroupPricing: '查看此分组定价',
    imagePricing: '图片计费',
    perImage: '/ 张',
    searchPlaceholder: '搜索品牌、分组名称、模型 ID 或显示名称',
    displayMode: '显示模式',
    displayByModel: '模型-分组',
    displayByGroup: '分组-模型',
    allBrands: '全部品牌',
    allPlatforms: '全部品牌',
    allTypes: '全部类型',
    allGroups: '全部分组',
    availableGroups: '个可用分组',
    matchingGroups: '匹配分组',
    matchingModels: '匹配模型',
    brandsStat: '个品牌',
    platformsStat: '个品牌',
    ...
    passiveAvailabilityAriaLabel: '最近 60 个时间桶，每桶 {minutes} 分钟：绿色表示成功或无数据，黄色表示存在降级或上游故障。',
    degradedTitle: '服务暂时降级',
    ...
    imageOutput: '图片输出',
    fastInput: 'Fast 输入',
    fastImageInput: 'Fast 图片输入',
    fastOutput: 'Fast 输出',
    fastCacheWrite: 'Fast 缓存写入',
    fastCacheRead: 'Fast 缓存读取',
    fastImageOutput: 'Fast 图片输出',
    unpriced: '暂无定价',
    pricingUnavailable: '暂未找到可展示的定价信息。',
    emptyTitle: '没有匹配的模型',
    emptyDescription: '可以尝试切换品牌筛选，或者修改搜索关键词。',
    platforms: {
      openai: 'OpenAI 格式',
  ...
  onboarding: {
    ...
    admin: {
      ...
      groupManage: {
        title: '📦 第一步：分组管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>什么是分组？</b></p><p style="margin-bottom: 12px;">分组是 TokenRouter 的核心概念，它就像一个"服务套餐"：</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 每个分组可以包含多个上游账号</li><li>💰 每个分组有独立的计费倍率</li><li>👥 可以设置为公开或专属分组</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 示例：</b>您可以创建"VIP专线"（高倍率）和"免费试用"（低倍率）两个分组</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 点击左侧的"分组管理"开始</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 TokenRouter',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 TokenRouter AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
...
// Payment System
  payment: {
    ...
    rechargeRatePreview: '当前倍率：1 CNY = {amount} {unitName}',
    refundReason: '退款原因',
    ...
    errors: {
      ...
      billingRequired: '请填写账单抬头和账单邮箱',
      billingEmailInvalid: '账单邮箱格式不正确',
      ...
      REFUND_FAILED: '退款失败',
      BILLING_INFO_REQUIRED: '请填写账单信息',
      BILLING_NAME_REQUIRED: '请填写账单抬头',
      BILLING_EMAIL_REQUIRED: '请填写账单邮箱',
      BILLING_EMAIL_INVALID: '账单邮箱格式不正确',
      BILLING_TAX_ID_INVALID: '税号类型和税号需要同时填写',
      PAYMENT_DOCUMENT_UNSUPPORTED: '该订单暂不支持账单/收据',
      PAYMENT_DOCUMENT_NOT_FOUND: '账单或收据暂不可用',
    },
    ...
    admin: {
      ...
      purchaseDistribution: '套餐/按量购买情况',
      purchaseItem: '购买项',
      amountShare: '金额占比',
      countShare: '订单数占比',
      payAsYouGo: '按量支付',
      ...
      userBalance: '用户余额',
      orderAmount: '订单金额',
      insufficientBalance: '余额不足，用户余额将扣减至 0',
      ...
      quotaRequired: '至少需要设置一个大于 0 的额度',
      groupMissing: '缺失',
      groupInfo: '分组信息',
      platform: '平台',
