...
// Accounts Management
    accounts: {
      ...
      usageWindowsHint: '“5h / 7d”是上游账号（如 OpenAI ChatGPT、Claude）官方的滚动用量窗口限制，由上游对账号设定，并非 TokenRouter 配置，也与你映射的模型无关。窗口滚动到期后用量会自动重置，无法在 TokenRouter 端解除该限制。',
      ollamaCloud: {
        ...
        notConfigured: '未配置',
        notRefreshed: '尚未刷新',
        encryptionKeyRequired: 'TOTP 加密密钥尚未完成数据库初始化，请在数据库初始化完成后重启服务。',
      ...
      openai: {
        ...
        codexFingerprintModeDesc: '多人共享同一 OAuth 账号时，可将设备/会话标识收敛为账号级恒定值。默认关闭，仅在需要时显式开启。',
        codexFingerprintOff: '关闭（默认）',
        ...
        testModeCompact: '旧版 Compact 端点探测',
      ...
      grokMediaEligibility: {
        ...
        forceEnableWarning: '强制启用会绕过自动资格检查，仅应对已确认支持生图或生视频的账号使用。',
      ...
      imageResponse: '接口响应详情',
      apiResponseDetails: '接口响应详情',
      copyApiResponse: '复制接口响应',
      imageResponseCopied: '接口响应已复制',
      completeResponse: '完整响应',
      sseEvents: 'SSE 事件',
      rawSseEvents: '上游原始 SSE 事件',
      copyCompleteResponse: '复制完整响应',
      completeResponseCopied: '完整响应已复制',
      copyRawSse: '复制全部原始 SSE',
      rawSseCopied: '原始 SSE 已复制',
      copySseEvent: '复制此 SSE 事件',
      sseEventCopied: 'SSE 事件已复制',
      audioPreview: '生成音频：',
