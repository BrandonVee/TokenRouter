...
// Channel Management
    channels: {
      ...
      form: {
        ...
        peakRateTitle: '峰谷价格',
        peakRateStatusOn: '已启用',
        peakRateStatusOff: '未启用',
        peakRateDescription: '按服务器时区，在指定时段叠加模型 Token 价格倍率',
        peakRateWindowsTitle: '价格时段',
        peakRateWindowsSummary: '{count} 个时段',
        peakRateWindowLabel: '峰谷时段 {index}',
        peakRateEnabled: '启用该模型峰谷价格',
        peakStart: '高峰开始',
        peakEnd: '高峰结束',
        peakRateMultiplier: '高峰价格倍率',
        peakRateWeekdays: '适用日期',
        addPeakRateWindow: '添加价格时段',
        removePeakRateWindow: '删除价格时段',
        peakRateHint: '按服务器时区计算；可设置多个时段并支持跨天',
        peakRateInvalid: '模型 {models} 的峰谷价格配置无效',
        peakRateWindowsRequired: '请至少添加一个价格时段',
        peakRateWindowsLimit: '最多可添加 32 个价格时段',
        peakRateWeekdaysInvalid: '每个价格时段至少选择一天，且日期不能重复',
        peakRateOverlap: '价格时段不能重叠',
        weekdayMon: '一',
        weekdayTue: '二',
        weekdayWed: '三',
        weekdayThu: '四',
