              ...
              <table class="w-full">
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td class="px-4 py-3 text-sm tabular-nums text-right font-medium text-gray-900 dark:text-white">{{ formatUsageBalance(row.actual_cost != null ? row.actual_cost : row.cost) }}</td>
                  </tr>
                </tbody>
              </table>
            </div>
...
const githubUrl = 'https://github.com/BrandonVee/TokenRouter'
...
:global(.dark) .skeleton {
  background: linear-gradient(90deg, #2A2E35 25%, #1B1E24 50%, #2A2E35 75%);
  background-size: 200% 100%;
}
