...
type UserEdges struct {
	...
	// RedeemCodeUsages holds the value of the redeem_code_usages edge.
	RedeemCodeUsages []*RedeemCodeUsage `json:"redeem_code_usages,omitempty"`
	...
	// DisabledPublicGroups holds the value of the disabled_public_groups edge.
	DisabledPublicGroups []*Group `json:"disabled_public_groups,omitempty"`
...
// QueryRedeemCodeUsages queries the "redeem_code_usages" edge of the User entity.
func (_m *User) QueryRedeemCodeUsages() *RedeemCodeUsageQuery {
	return NewUserClient(_m.config).QueryRedeemCodeUsages(_m)
}
...
// QueryDisabledPublicGroups queries the "disabled_public_groups" edge of the User entity.
func (_m *User) QueryDisabledPublicGroups() *GroupQuery {
	return NewUserClient(_m.config).QueryDisabledPublicGroups(_m)
}
...
// QueryUserDisabledPublicGroups queries the "user_disabled_public_groups" edge of the User entity.
func (_m *User) QueryUserDisabledPublicGroups() *UserDisabledPublicGroupQuery {
	return NewUserClient(_m.config).QueryUserDisabledPublicGroups(_m)
}
