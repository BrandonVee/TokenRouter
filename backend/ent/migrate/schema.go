...
var (
	...
	APIKeysColumns = []*schema.Column{
		...
		{Name: "rate_limit_30d", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		...
		{Name: "usage_30d", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		...
		{Name: "window_30d_start", Type: field.TypeTime, Nullable: true},
	...
	PaymentOrdersColumns = []*schema.Column{
		...
		{Name: "fee_fixed", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "fee_rate_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		...
		{Name: "payment_customer_id", Type: field.TypeString, Nullable: true, Size: 128},
		{Name: "payment_invoice_id", Type: field.TypeString, Nullable: true, Size: 128},
		{Name: "payment_invoice_url", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
		{Name: "payment_invoice_pdf_url", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
		{Name: "payment_invoice_status", Type: field.TypeString, Nullable: true, Size: 30},
	...
	PaymentOrdersTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{PaymentOrdersColumns[12], PaymentOrdersColumns[38]},
			},
			{
	...
	RedeemCodeUsagesTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "redeem_code_usages_redeem_codes_usage_records",
				Columns:    []*schema.Column{RedeemCodeUsagesColumns[2]},
				RefColumns: []*schema.Column{RedeemCodesColumns[0]},
				OnDelete:   schema.NoAction,
			},
			{
				Symbol:     "redeem_code_usages_users_redeem_code_usages",
				Columns:    []*schema.Column{RedeemCodeUsagesColumns[3]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.NoAction,
			},
		},
		Indexes: []*schema.Index{
			...
			{
				Name:    "redeemcodeusage_redeem_code_id_user_id",
				Unique:  true,
				Columns: []*schema.Column{RedeemCodeUsagesColumns[2], RedeemCodeUsagesColumns[3]},
			},
		},
	}
	...
	SubscriptionPlansColumns = []*schema.Column{
		...
		{Name: "group_ids", Type: field.TypeJSON, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "group_rate_multipliers", Type: field.TypeJSON, SchemaType: map[string]string{"postgres": "jsonb"}},
	...
	TLSFingerprintRoutersTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			{
				Name:    "tlsfingerprintrouter_enabled",
				Unique:  false,
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "subscription_amount_usd", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "balance_amount_usd", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
	...
	UserSubscriptionsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "usersubscription_starts_at",
				Unique:  false,
			...
			{
				Name:    "usersubscription_source_order_id",
				Unique:  false,
				Columns: []*schema.Column{UserSubscriptionsColumns[17]},
			},
			{
				Name:    "usersubscription_user_id_status_starts_at_expires_at",
				Unique:  false,
				Columns: []*schema.Column{UserSubscriptionsColumns[20], UserSubscriptionsColumns[6], UserSubscriptionsColumns[4], UserSubscriptionsColumns[5]},
			},
			{
			...
			{
				Name:    "usersubscription_user_id_plan_id_starts_at",
				Unique:  false,
				Columns: []*schema.Column{UserSubscriptionsColumns[20], UserSubscriptionsColumns[19], UserSubscriptionsColumns[4]},
			},
			{
