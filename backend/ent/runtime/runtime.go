...
import (
	...
	"github.com/BrandonVee/TokenRouter/ent/schema"
	...
	"github.com/BrandonVee/TokenRouter/ent/teaminvitation"
	"github.com/BrandonVee/TokenRouter/ent/teammembership"
	"github.com/BrandonVee/TokenRouter/ent/teamownershiptransfer"
	"github.com/BrandonVee/TokenRouter/ent/tlsfingerprintprofile"
	...
	"github.com/BrandonVee/TokenRouter/ent/userallowedgroup"
...
func init() {
	...
	apikeycompositegroupFields := schema.APIKeyCompositeGroup{}.Fields()
	_ = apikeycompositegroupFields
	// apikeycompositegroupDescCreatedAt is the schema descriptor for created_at field.
	apikeycompositegroupDescCreatedAt := apikeycompositegroupMixinFields0[0].Descriptor()
	// apikeycompositegroup.DefaultCreatedAt holds the default value on creation for the created_at field.
	apikeycompositegroup.DefaultCreatedAt = apikeycompositegroupDescCreatedAt.Default.(func() time.Time)
	// apikeycompositegroupDescUpdatedAt is the schema descriptor for updated_at field.
	apikeycompositegroupDescUpdatedAt := apikeycompositegroupMixinFields0[1].Descriptor()
	// apikeycompositegroup.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	apikeycompositegroup.DefaultUpdatedAt = apikeycompositegroupDescUpdatedAt.Default.(func() time.Time)
	// apikeycompositegroup.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	apikeycompositegroup.UpdateDefaultUpdatedAt = apikeycompositegroupDescUpdatedAt.UpdateDefault.(func() time.Time)
	// apikeycompositegroupDescPrefix is the schema descriptor for prefix field.
	apikeycompositegroupDescPrefix := apikeycompositegroupFields[2].Descriptor()
	// apikeycompositegroup.PrefixValidator is a validator for the "prefix" field. It is called by the builders before save.
	apikeycompositegroup.PrefixValidator = func() func(string) error {
		validators := apikeycompositegroupDescPrefix.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// apikeycompositegroupDescNormalizedPrefix is the schema descriptor for normalized_prefix field.
	apikeycompositegroupDescNormalizedPrefix := apikeycompositegroupFields[3].Descriptor()
	// apikeycompositegroup.NormalizedPrefixValidator is a validator for the "normalized_prefix" field. It is called by the builders before save.
	apikeycompositegroup.NormalizedPrefixValidator = func() func(string) error {
		validators := apikeycompositegroupDescNormalizedPrefix.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
		return func(normalized_prefix string) error {
			for _, fn := range fns {
				if err := fn(normalized_prefix); err != nil {
					return err
				}
			}
			return nil
	...
	// apikeycompositegroupDescSortOrder is the schema descriptor for sort_order field.
	...
	// apikeycompositegroupDescDataSharingNoticeVersion is the schema descriptor for data_sharing_notice_version field.
	apikeycompositegroupDescDataSharingNoticeVersion := apikeycompositegroupFields[5].Descriptor()
	// apikeycompositegroup.DefaultDataSharingNoticeVersion holds the default value on creation for the data_sharing_notice_version field.
	apikeycompositegroup.DefaultDataSharingNoticeVersion = apikeycompositegroupDescDataSharingNoticeVersion.Default.(int)
	...
	// batchimagejobDescBillingMode is the schema descriptor for billing_mode field.
	batchimagejobDescBillingMode := batchimagejobFields[6].Descriptor()
	// batchimagejob.DefaultBillingMode holds the default value on creation for the billing_mode field.
	...
	// batchimagejobDescBalanceHoldAmount is the schema descriptor for balance_hold_amount field.
	batchimagejobDescBalanceHoldAmount := batchimagejobFields[24].Descriptor()
	// batchimagejob.DefaultBalanceHoldAmount holds the default value on creation for the balance_hold_amount field.
	batchimagejob.DefaultBalanceHoldAmount = batchimagejobDescBalanceHoldAmount.Default.(float64)
	...
	batchimagejob.DefaultSubscriptionRateMultiplier = batchimagejobDescSubscriptionRateMultiplier.Default.(float64)
	// batchimagejobDescBalanceRateMultiplier is the schema descriptor for balance_rate_multiplier field.
	batchimagejobDescBalanceRateMultiplier := batchimagejobFields[27].Descriptor()
	// batchimagejob.DefaultBalanceRateMultiplier holds the default value on creation for the balance_rate_multiplier field.
	batchimagejob.DefaultBalanceRateMultiplier = batchimagejobDescBalanceRateMultiplier.Default.(float64)
	// batchimagejobDescPlanGroupRateMultiplierEnabled is the schema descriptor for plan_group_rate_multiplier_enabled field.
	batchimagejobDescPlanGroupRateMultiplierEnabled := batchimagejobFields[28].Descriptor()
	// batchimagejob.DefaultPlanGroupRateMultiplierEnabled holds the default value on creation for the plan_group_rate_multiplier_enabled field.
	batchimagejob.DefaultPlanGroupRateMultiplierEnabled = batchimagejobDescPlanGroupRateMultiplierEnabled.Default.(bool)
	// batchimagejobDescAllowanceReserved is the schema descriptor for allowance_reserved field.
	batchimagejobDescAllowanceReserved := batchimagejobFields[29].Descriptor()
	...
	batchimagejobDescCurrency := batchimagejobFields[30].Descriptor()
	...
	batchimagejobDescHoldID := batchimagejobFields[31].Descriptor()
	...
	batchimagejobDescIdempotencyKey := batchimagejobFields[32].Descriptor()
	...
	batchimagejobDescRequestHash := batchimagejobFields[33].Descriptor()
	...
	batchimagejobDescManifestHash := batchimagejobFields[34].Descriptor()
	...
	batchimagejobDescRetryCount := batchimagejobFields[35].Descriptor()
	...
	batchimagejobDescVersion := batchimagejobFields[36].Descriptor()
	...
	batchimagejobDescLastErrorCode := batchimagejobFields[42].Descriptor()
	...
	batchimagejobDescCreatedAt := batchimagejobFields[44].Descriptor()
	...
	batchimagejobDescUpdatedAt := batchimagejobFields[45].Descriptor()
	...
	// datasharesessionDescRequestPath is the schema descriptor for request_path field.
	datasharesessionDescRequestPath := datasharesessionFields[5].Descriptor()
	// datasharesession.DefaultRequestPath holds the default value on creation for the request_path field.
	datasharesession.DefaultRequestPath = datasharesessionDescRequestPath.Default.(string)
	// datasharesession.RequestPathValidator is a validator for the "request_path" field. It is called by the builders before save.
	datasharesession.RequestPathValidator = datasharesessionDescRequestPath.Validators[0].(func(string) error)
	// datasharesessionDescUserAgent is the schema descriptor for user_agent field.
	datasharesessionDescUserAgent := datasharesessionFields[6].Descriptor()
	// datasharesession.DefaultUserAgent holds the default value on creation for the user_agent field.
	datasharesession.DefaultUserAgent = datasharesessionDescUserAgent.Default.(string)
	// datasharesession.UserAgentValidator is a validator for the "user_agent" field. It is called by the builders before save.
	datasharesession.UserAgentValidator = datasharesessionDescUserAgent.Validators[0].(func(string) error)
	// datasharesessionDescStatus is the schema descriptor for status field.
	datasharesessionDescStatus := datasharesessionFields[7].Descriptor()
	...
	datasharesessionDescIsFinalSnapshot := datasharesessionFields[8].Descriptor()
	...
	datasharesessionDescSourceRequestCount := datasharesessionFields[9].Descriptor()
	...
	// datasharesessionDescPayloadEncoding is the schema descriptor for payload_encoding field.
	datasharesessionDescPayloadEncoding := datasharesessionFields[17].Descriptor()
	// datasharesession.DefaultPayloadEncoding holds the default value on creation for the payload_encoding field.
	datasharesession.DefaultPayloadEncoding = datasharesessionDescPayloadEncoding.Default.(string)
	// datasharesession.PayloadEncodingValidator is a validator for the "payload_encoding" field. It is called by the builders before save.
	datasharesession.PayloadEncodingValidator = datasharesessionDescPayloadEncoding.Validators[0].(func(string) error)
	// datasharesessionDescPayloadBytes is the schema descriptor for payload_bytes field.
	datasharesessionDescPayloadBytes := datasharesessionFields[18].Descriptor()
	// datasharesession.DefaultPayloadBytes holds the default value on creation for the payload_bytes field.
	datasharesession.DefaultPayloadBytes = datasharesessionDescPayloadBytes.Default.(int64)
	// datasharesessionDescExportable is the schema descriptor for exportable field.
	datasharesessionDescExportable := datasharesessionFields[19].Descriptor()
	...
	datasharesessionDescQualityStatus := datasharesessionFields[20].Descriptor()
	...
	datasharesessionDescStorageBytes := datasharesessionFields[22].Descriptor()
	...
	datasharesessionDescInputTokens := datasharesessionFields[23].Descriptor()
	...
	datasharesessionDescOutputTokens := datasharesessionFields[24].Descriptor()
	...
	datasharesessionDescTotalTokens := datasharesessionFields[25].Descriptor()
	...
	groupDescAvailabilityProbeConfig := groupFields[54].Descriptor()
	...
	groupDescDataSharingEnabled := groupFields[58].Descriptor()
	...
	groupDescSessionIsolationEnabled := groupFields[59].Descriptor()
	...
	invoiceattachmentDescFileName := invoiceattachmentFields[1].Descriptor()
	// invoiceattachment.FileNameValidator is a validator for the "file_name" field. It is called by the builders before save.
	invoiceattachment.FileNameValidator = invoiceattachmentDescFileName.Validators[0].(func(string) error)
	// invoiceattachmentDescContentType is the schema descriptor for content_type field.
	invoiceattachmentDescContentType := invoiceattachmentFields[2].Descriptor()
	// invoiceattachment.ContentTypeValidator is a validator for the "content_type" field. It is called by the builders before save.
	invoiceattachment.ContentTypeValidator = invoiceattachmentDescContentType.Validators[0].(func(string) error)
	// invoiceattachmentDescStorageKey is the schema descriptor for storage_key field.
	...
	_ = invoicedeliveryFields
	// invoicedeliveryDescRecipientEmail is the schema descriptor for recipient_email field.
	invoicedeliveryDescRecipientEmail := invoicedeliveryFields[1].Descriptor()
	// invoicedelivery.RecipientEmailValidator is a validator for the "recipient_email" field. It is called by the builders before save.
	invoicedelivery.RecipientEmailValidator = invoicedeliveryDescRecipientEmail.Validators[0].(func(string) error)
	// invoicedeliveryDescStatus is the schema descriptor for status field.
	invoicedeliveryDescStatus := invoicedeliveryFields[2].Descriptor()
	// invoicedelivery.StatusValidator is a validator for the "status" field. It is called by the builders before save.
	invoicedelivery.StatusValidator = invoicedeliveryDescStatus.Validators[0].(func(string) error)
	// invoicedeliveryDescMessageID is the schema descriptor for message_id field.
	invoicedeliveryDescMessageID := invoicedeliveryFields[3].Descriptor()
	// invoicedelivery.MessageIDValidator is a validator for the "message_id" field. It is called by the builders before save.
	invoicedelivery.MessageIDValidator = invoicedeliveryDescMessageID.Validators[0].(func(string) error)
	// invoicedeliveryDescCreatedAt is the schema descriptor for created_at field.
	invoicedeliveryDescCreatedAt := invoicedeliveryFields[7].Descriptor()
	// invoicedelivery.DefaultCreatedAt holds the default value on creation for the created_at field.
	invoicedelivery.DefaultCreatedAt = invoicedeliveryDescCreatedAt.Default.(func() time.Time)
	invoicerequestFields := schema.InvoiceRequest{}.Fields()
	_ = invoicerequestFields
	// invoicerequestDescRequestNo is the schema descriptor for request_no field.
	invoicerequestDescRequestNo := invoicerequestFields[1].Descriptor()
	// invoicerequest.RequestNoValidator is a validator for the "request_no" field. It is called by the builders before save.
	invoicerequest.RequestNoValidator = invoicerequestDescRequestNo.Validators[0].(func(string) error)
	// invoicerequestDescStatus is the schema descriptor for status field.
	invoicerequestDescStatus := invoicerequestFields[2].Descriptor()
	...
	invoicerequestDescCurrency := invoicerequestFields[3].Descriptor()
	...
	invoicerequestDescInvoiceType := invoicerequestFields[5].Descriptor()
	...
	invoicerequestDescInvoiceTitle := invoicerequestFields[6].Descriptor()
	...
	// invoicerequestDescTaxID is the schema descriptor for tax_id field.
	invoicerequestDescTaxID := invoicerequestFields[7].Descriptor()
	// invoicerequest.TaxIDValidator is a validator for the "tax_id" field. It is called by the builders before save.
	invoicerequest.TaxIDValidator = invoicerequestDescTaxID.Validators[0].(func(string) error)
	...
	invoicerequestDescRecipientEmail := invoicerequestFields[10].Descriptor()
	...
	// invoicerequestDescAccountEmail is the schema descriptor for account_email field.
	invoicerequestDescAccountEmail := invoicerequestFields[11].Descriptor()
	// invoicerequest.AccountEmailValidator is a validator for the "account_email" field. It is called by the builders before save.
	invoicerequest.AccountEmailValidator = invoicerequestDescAccountEmail.Validators[0].(func(string) error)
	// invoicerequestDescInvoiceNumber is the schema descriptor for invoice_number field.
	invoicerequestDescInvoiceNumber := invoicerequestFields[16].Descriptor()
	// invoicerequest.InvoiceNumberValidator is a validator for the "invoice_number" field. It is called by the builders before save.
	invoicerequest.InvoiceNumberValidator = invoicerequestDescInvoiceNumber.Validators[0].(func(string) error)
	...
	invoicerequestitemFields := schema.InvoiceRequestItem{}.Fields()
	_ = invoicerequestitemFields
	// invoicerequestitemDescActive is the schema descriptor for active field.
	invoicerequestitemDescActive := invoicerequestitemFields[2].Descriptor()
	// invoicerequestitem.DefaultActive holds the default value on creation for the active field.
	invoicerequestitem.DefaultActive = invoicerequestitemDescActive.Default.(bool)
	// invoicerequestitemDescOrderNo is the schema descriptor for order_no field.
	invoicerequestitemDescOrderNo := invoicerequestitemFields[3].Descriptor()
	// invoicerequestitem.OrderNoValidator is a validator for the "order_no" field. It is called by the builders before save.
	invoicerequestitem.OrderNoValidator = invoicerequestitemDescOrderNo.Validators[0].(func(string) error)
	// invoicerequestitemDescOrderType is the schema descriptor for order_type field.
	invoicerequestitemDescOrderType := invoicerequestitemFields[4].Descriptor()
	// invoicerequestitem.OrderTypeValidator is a validator for the "order_type" field. It is called by the builders before save.
	invoicerequestitem.OrderTypeValidator = invoicerequestitemDescOrderType.Validators[0].(func(string) error)
	// invoicerequestitemDescCurrency is the schema descriptor for currency field.
	invoicerequestitemDescCurrency := invoicerequestitemFields[5].Descriptor()
	// invoicerequestitem.CurrencyValidator is a validator for the "currency" field. It is called by the builders before save.
	invoicerequestitem.CurrencyValidator = invoicerequestitemDescCurrency.Validators[0].(func(string) error)
	// invoicerequestitemDescCreditedAmount is the schema descriptor for credited_amount field.
	invoicerequestitemDescCreditedAmount := invoicerequestitemFields[7].Descriptor()
	// invoicerequestitem.DefaultCreditedAmount holds the default value on creation for the credited_amount field.
	invoicerequestitem.DefaultCreditedAmount = invoicerequestitemDescCreditedAmount.Default.(float64)
	// invoicerequestitemDescRechargeCode is the schema descriptor for recharge_code field.
	invoicerequestitemDescRechargeCode := invoicerequestitemFields[8].Descriptor()
	// invoicerequestitem.RechargeCodeValidator is a validator for the "recharge_code" field. It is called by the builders before save.
	invoicerequestitem.RechargeCodeValidator = invoicerequestitemDescRechargeCode.Validators[0].(func(string) error)
	// invoicerequestitemDescCreatedAt is the schema descriptor for created_at field.
	invoicerequestitemDescCreatedAt := invoicerequestitemFields[11].Descriptor()
	// invoicerequestitem.DefaultCreatedAt holds the default value on creation for the created_at field.
	invoicerequestitem.DefaultCreatedAt = invoicerequestitemDescCreatedAt.Default.(func() time.Time)
	...
	// paymentorderDescFeeFixed is the schema descriptor for fee_fixed field.
	paymentorderDescFeeFixed := paymentorderFields[7].Descriptor()
	// paymentorder.DefaultFeeFixed holds the default value on creation for the fee_fixed field.
	paymentorder.DefaultFeeFixed = paymentorderDescFeeFixed.Default.(float64)
	// paymentorderDescFeeRateAmount is the schema descriptor for fee_rate_amount field.
	paymentorderDescFeeRateAmount := paymentorderFields[8].Descriptor()
	// paymentorder.DefaultFeeRateAmount holds the default value on creation for the fee_rate_amount field.
	paymentorder.DefaultFeeRateAmount = paymentorderDescFeeRateAmount.Default.(float64)
	...
	team.DefaultMonthlyLimitUsdValidator = teamDescDefaultMonthlyLimitUsd.Validators[0].(func(float64) error)
	...
	teaminvitationDescEmail := teaminvitationFields[2].Descriptor()
	...
	// teammembership.RoleValidator is a validator for the "role" field. It is called by the builders before save.
	teammembership.RoleValidator = func() func(string) error {
		validators := teammembershipDescRole.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// teammembershipDescDailyLimitUsd is the schema descriptor for daily_limit_usd field.
	teammembershipDescDailyLimitUsd := teammembershipFields[3].Descriptor()
	// teammembership.DefaultDailyLimitUsd holds the default value on creation for the daily_limit_usd field.
	teammembership.DefaultDailyLimitUsd = teammembershipDescDailyLimitUsd.Default.(float64)
	// teammembership.DailyLimitUsdValidator is a validator for the "daily_limit_usd" field. It is called by the builders before save.
	teammembership.DailyLimitUsdValidator = teammembershipDescDailyLimitUsd.Validators[0].(func(float64) error)
	// teammembershipDescWeeklyLimitUsd is the schema descriptor for weekly_limit_usd field.
	teammembershipDescWeeklyLimitUsd := teammembershipFields[4].Descriptor()
	// teammembership.DefaultWeeklyLimitUsd holds the default value on creation for the weekly_limit_usd field.
	teammembership.DefaultWeeklyLimitUsd = teammembershipDescWeeklyLimitUsd.Default.(float64)
	// teammembership.WeeklyLimitUsdValidator is a validator for the "weekly_limit_usd" field. It is called by the builders before save.
	teammembership.WeeklyLimitUsdValidator = teammembershipDescWeeklyLimitUsd.Validators[0].(func(float64) error)
	// teammembershipDescMonthlyLimitUsd is the schema descriptor for monthly_limit_usd field.
	teammembershipDescMonthlyLimitUsd := teammembershipFields[5].Descriptor()
	// teammembership.DefaultMonthlyLimitUsd holds the default value on creation for the monthly_limit_usd field.
	teammembership.DefaultMonthlyLimitUsd = teammembershipDescMonthlyLimitUsd.Default.(float64)
	// teammembership.MonthlyLimitUsdValidator is a validator for the "monthly_limit_usd" field. It is called by the builders before save.
	teammembership.MonthlyLimitUsdValidator = teammembershipDescMonthlyLimitUsd.Validators[0].(func(float64) error)
	// teammembershipDescDailyUsageUsd is the schema descriptor for daily_usage_usd field.
	teammembershipDescDailyUsageUsd := teammembershipFields[6].Descriptor()
	// teammembership.DefaultDailyUsageUsd holds the default value on creation for the daily_usage_usd field.
	teammembership.DefaultDailyUsageUsd = teammembershipDescDailyUsageUsd.Default.(float64)
	// teammembership.DailyUsageUsdValidator is a validator for the "daily_usage_usd" field. It is called by the builders before save.
	teammembership.DailyUsageUsdValidator = teammembershipDescDailyUsageUsd.Validators[0].(func(float64) error)
	// teammembershipDescWeeklyUsageUsd is the schema descriptor for weekly_usage_usd field.
	teammembershipDescWeeklyUsageUsd := teammembershipFields[7].Descriptor()
	// teammembership.DefaultWeeklyUsageUsd holds the default value on creation for the weekly_usage_usd field.
	teammembership.DefaultWeeklyUsageUsd = teammembershipDescWeeklyUsageUsd.Default.(float64)
	// teammembership.WeeklyUsageUsdValidator is a validator for the "weekly_usage_usd" field. It is called by the builders before save.
	teammembership.WeeklyUsageUsdValidator = teammembershipDescWeeklyUsageUsd.Validators[0].(func(float64) error)
	// teammembershipDescMonthlyUsageUsd is the schema descriptor for monthly_usage_usd field.
	teammembershipDescMonthlyUsageUsd := teammembershipFields[8].Descriptor()
	// teammembership.DefaultMonthlyUsageUsd holds the default value on creation for the monthly_usage_usd field.
	teammembership.DefaultMonthlyUsageUsd = teammembershipDescMonthlyUsageUsd.Default.(float64)
	// teammembership.MonthlyUsageUsdValidator is a validator for the "monthly_usage_usd" field. It is called by the builders before save.
	teammembership.MonthlyUsageUsdValidator = teammembershipDescMonthlyUsageUsd.Validators[0].(func(float64) error)
	// teammembershipDescJoinedAt is the schema descriptor for joined_at field.
	teammembershipDescJoinedAt := teammembershipFields[12].Descriptor()
	...
	teamownershiptransferMixin := schema.TeamOwnershipTransfer{}.Mixin()
	teamownershiptransferMixinFields0 := teamownershiptransferMixin[0].Fields()
	_ = teamownershiptransferMixinFields0
	teamownershiptransferFields := schema.TeamOwnershipTransfer{}.Fields()
	_ = teamownershiptransferFields
	// teamownershiptransferDescCreatedAt is the schema descriptor for created_at field.
	teamownershiptransferDescCreatedAt := teamownershiptransferMixinFields0[0].Descriptor()
	// teamownershiptransfer.DefaultCreatedAt holds the default value on creation for the created_at field.
	teamownershiptransfer.DefaultCreatedAt = teamownershiptransferDescCreatedAt.Default.(func() time.Time)
	// teamownershiptransferDescUpdatedAt is the schema descriptor for updated_at field.
	teamownershiptransferDescUpdatedAt := teamownershiptransferMixinFields0[1].Descriptor()
	// teamownershiptransfer.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	teamownershiptransfer.DefaultUpdatedAt = teamownershiptransferDescUpdatedAt.Default.(func() time.Time)
	// teamownershiptransfer.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	teamownershiptransfer.UpdateDefaultUpdatedAt = teamownershiptransferDescUpdatedAt.UpdateDefault.(func() time.Time)
	// teamownershiptransferDescTokenHash is the schema descriptor for token_hash field.
	teamownershiptransferDescTokenHash := teamownershiptransferFields[3].Descriptor()
	// teamownershiptransfer.TokenHashValidator is a validator for the "token_hash" field. It is called by the builders before save.
	teamownershiptransfer.TokenHashValidator = func() func(string) error {
		validators := teamownershiptransferDescTokenHash.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// teamownershiptransferDescStatus is the schema descriptor for status field.
	teamownershiptransferDescStatus := teamownershiptransferFields[4].Descriptor()
	// teamownershiptransfer.DefaultStatus holds the default value on creation for the status field.
	teamownershiptransfer.DefaultStatus = teamownershiptransferDescStatus.Default.(string)
	// teamownershiptransfer.StatusValidator is a validator for the "status" field. It is called by the builders before save.
	teamownershiptransfer.StatusValidator = func() func(string) error {
		validators := teamownershiptransferDescStatus.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	usagelogDescSubscriptionAmountUsd := usagelogFields[27].Descriptor()
	...
	usagelogDescBalanceAmountUsd := usagelogFields[28].Descriptor()
