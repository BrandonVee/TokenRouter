...
func TestGetFallbackPricing_FamilyMatching(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "deepseek v4 flash vision", model: "deepseek-v4-flash-vision-exp", expectedInput: 2.2e-7, expectedOutput: testPtrFloat64(6.6e-7), expectedCache: testPtrFloat64(7e-9)},
		{name: "deepseek chat alias", model: "deepseek-chat", expectedInput: 2.2e-7, expectedOutput: testPtrFloat64(6.6e-7), expectedCache: testPtrFloat64(7e-9)},
		{name: "deepseek reasoner alias", model: "deepseek-reasoner", expectedInput: 2.2e-7, expectedOutput: testPtrFloat64(6.6e-7), expectedCache: testPtrFloat64(7e-9)},
		{name: "deepseek unknown model", model: "deepseek-foo", expectedInput: 2.2e-7, expectedOutput: testPtrFloat64(6.6e-7), expectedCache: testPtrFloat64(7e-9)},
