...
import (
	...
	httppool "github.com/BrandonVee/TokenRouter/internal/pkg/httpclient"
	openaipkg "github.com/BrandonVee/TokenRouter/internal/pkg/openai"
...
type UsageLogRepository interface {
	...
	GetUsageRanking(ctx context.Context, startTime, endTime time.Time, limit int, sortBy string) (*usagestats.UsageRankingResponse, error)
...
func (s *AccountUsageService) getQoderUsage(ctx context.Context, account *Account, force bool) (*UsageInfo, error) {
	...
	result, flightErr, _ := s.cache.qoderFlight.Do(flightKey, func() (any, error) {
		...
		resp, err := s.fetchQoderQuotaUsage(fetchCtx, account)
		if err != nil {
